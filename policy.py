...
class Policy:
	...
	def __init__(self):
		...
		policy_matrix_up = [[None for x in xrange(6)] for y in xrange(6)]
		policy_matrix_right = [[None for x in xrange(6)] for y in xrange(6)]
		policy_matrix_down = [[None for x in xrange(6)] for y in xrange(6)]
		policy_matrix_left = [[None for x in xrange(6)] for y in xrange(6)]
